...
class Acceptor {
 ...
 public:
    void Init(LoopPoolPtr workLoops, LoopPtr listenLoop, const std::string& Ip,
              uint32_t port, const Session::FunSessionRead& funSessionRead);
    ...
    LoopPoolPtr GetWorkLoop() { return m_workLoop; }
    LoopPtr GetListenLoop() { return m_listenLoop; }
