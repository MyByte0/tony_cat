...
uint32_t PaserRawData(const std::string& strInput, uint32_t nStart,
    ...
    nLen = *reinterpret_cast<const uint32_t*>(pInput);
...
void PaserList(const std::string& strInput,
...
void PaserList(const std::string& strInput,
               std::unordered_set<std::string>& setElems) {
    uint32_t indexBegin = 0;
    std::string strData;
    while (indexBegin < strInput.size()) {
        indexBegin = PaserRawData(strInput, indexBegin, strData);
...
void PacketList(const std::vector<std::string>& setInput,
                std::string& strOutput) {
    for (const auto& elemInput : setInput) {
        AppendRawData(strOutput, elemInput);
    }
}

void PacketList(const std::unordered_set<std::string>& vecInput,
                std::string& strOutput) {
    for (const auto& elemInput : vecInput) {
        AppendRawData(strOutput, elemInput);
    }
}
...
bool IsDBKey(const google::protobuf::Message& message,
    ...
    return gPbKeys.mapMesssageKeys.count(message.GetTypeName()) > 0 &&
           gPbKeys.mapMesssageKeys[message.GetTypeName()].count(
               fieldDescriptor.name()) > 0;
}

bool IsDBCommonKeyType(google::protobuf::FieldDescriptor::CppType cppType) {
    return cppType ==
               google::protobuf::FieldDescriptor::CppType::CPPTYPE_INT32 ||
           cppType ==
               google::protobuf::FieldDescriptor::CppType::CPPTYPE_UINT32 ||
           cppType ==
               google::protobuf::FieldDescriptor::CppType::CPPTYPE_INT64 ||
           cppType ==
               google::protobuf::FieldDescriptor::CppType::CPPTYPE_UINT64 ||
           cppType ==
               google::protobuf::FieldDescriptor::CppType::CPPTYPE_STRING;
}
...
void DBStringToProtoMessage(
    ...
    switch (fieldDescriptor.cpp_type()) {
        case google::protobuf::FieldDescriptor::CPPTYPE_DOUBLE:
            reflection->SetDouble(&message, &fieldDescriptor,
                                  ::atof(value.c_str()));
            break;
        case google::protobuf::FieldDescriptor::CPPTYPE_FLOAT:
            reflection->SetFloat(&message, &fieldDescriptor,
                                 static_cast<float>(::atof(value.c_str())));
            break;
        case google::protobuf::FieldDescriptor::CPPTYPE_ENUM:
            reflection->SetEnumValue(&message, &fieldDescriptor,
                                     ::atoi(value.c_str()));
            break;
        ...
        case google::protobuf::FieldDescriptor::CPPTYPE_INT64:
            reflection->SetInt64(&message, &fieldDescriptor,
                                 ::atoll(value.c_str()));
            break;
        case google::protobuf::FieldDescriptor::CPPTYPE_INT32:
            reflection->SetInt32(&message, &fieldDescriptor,
                                 ::atoi(value.c_str()));
            break;
        case google::protobuf::FieldDescriptor::CPPTYPE_UINT64:
            reflection->SetUInt64(&message, &fieldDescriptor,
                                  ::strtoull(value.c_str(), nullptr, 10));
            break;
        case google::protobuf::FieldDescriptor::CPPTYPE_UINT32:
            reflection->SetUInt32(
                &message, &fieldDescriptor,
                static_cast<uint32_t>(::atoll(value.c_str())));
            break;
        case google::protobuf::FieldDescriptor::CPPTYPE_BOOL:
            reflection->SetBool(&message, &fieldDescriptor,
                                ::atoi(value.c_str()) != 0);
            break;
        default:
            break;
...
void DBStringToProtoMessageAsBlob(
    ...
    sub_message->ParseFromArray(value.c_str(),
...
std::string DBProtoMessageToString(
    ...
    switch (fieldDescriptor.cpp_type()) {
        case google::protobuf::FieldDescriptor::CPPTYPE_DOUBLE:
            strRet = std::to_string(
                reflection->GetDouble(message, &fieldDescriptor));
            break;
        case google::protobuf::FieldDescriptor::CPPTYPE_FLOAT:
            strRet =
                std::to_string(reflection->GetFloat(message, &fieldDescriptor));
            break;
        case google::protobuf::FieldDescriptor::CPPTYPE_ENUM:
            strRet = std::to_string(
                reflection->GetEnumValue(message, &fieldDescriptor));
            break;
        case google::protobuf::FieldDescriptor::CPPTYPE_MESSAGE: {
        ...
        case google::protobuf::FieldDescriptor::CPPTYPE_INT64:
            strRet =
                std::to_string(reflection->GetInt64(message, &fieldDescriptor));
            break;
        case google::protobuf::FieldDescriptor::CPPTYPE_INT32:
            strRet =
                std::to_string(reflection->GetInt32(message, &fieldDescriptor));
            break;
        case google::protobuf::FieldDescriptor::CPPTYPE_UINT64:
            strRet = std::to_string(
                reflection->GetUInt64(message, &fieldDescriptor));
            break;
        case google::protobuf::FieldDescriptor::CPPTYPE_UINT32:
            strRet = std::to_string(
                reflection->GetUInt32(message, &fieldDescriptor));
            break;
        case google::protobuf::FieldDescriptor::CPPTYPE_BOOL:
            strRet =
                std::to_string(reflection->GetBool(message, &fieldDescriptor));
            break;
        default:
            break;
    }
...
std::string PbMessageKVHandle::GetMessageElementKey(
    ...
    strElementKey.append(strTabName)
...
std::string PbMessageKVHandle::GetMessageRepeatedElementKey(
    const std::string& strTabName, const std::string& strCommonKeyList,
    ...
    strElementKey.append(strTabName)
        .append(strTableSpacer)
        .append(strCommonKeyList);
    auto pMsg = &(pReflection->GetRepeatedMessage(message, pFieldDescriptor,
                                                  iChildField));
...
int32_t PbMessageKVHandle::MessageLoadOnKV(google::protobuf::Message& message) {
    ...
    for (int iField = 0; iField < pDescriptor->field_count(); ++iField) {
        ...
        if (IsDBCommonKeyType(pFieldDescriptor->cpp_type())) {
            AppendRawData(strCommonKeyList,
        ...
        if (pFieldDescriptor->is_repeated() &&
            ...
            for (int iChildField = 0;
                 ...
                 ++iChildField) {
                std::string strElementKey = GetMessageRepeatedElementKey(
                    strTabName, strCommonKeyList, iChildField, message,
                    pReflection, pFieldDescriptor);
            ...
            std::string strElementKey =
                GetMessageElementKey(strTabName, strCommonKeyList, message,
                                     pReflection, pFieldDescriptor);
            vecKeySet.emplace_back(std::move(strElementKey));
        } else {
...
int32_t PbMessageKVHandle::MessageUpdateOnKV(
    google::protobuf::Message& message) {
    auto pReflection = message.GetReflection();
    auto pDescriptor = message.GetDescriptor();
...
int32_t PbMessageKVHandle::MessageDeleteOnKV(
    google::protobuf::Message& message) {
    auto pReflection = message.GetReflection();
    auto pDescriptor = message.GetDescriptor();
