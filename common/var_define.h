...
#define DEFINE_MEMBER_INT_TYPE_PUBLIC(_TYPE, _NAME)     \
    DEFINE_MEMBER_INT_TYPE(_TYPE, _NAME, public)

#define DEFINE_MEMBER_INT_TYPE_PRIVATE(_TYPE, _NAME)    \
    DEFINE_MEMBER_INT_TYPE(_TYPE, _NAME, private)


#define DEFINE_MEMBER_INT8_PUBLIC(_NAME)                \
    DEFINE_MEMBER_INT_TYPE_PUBLIC(int8_t, _NAME)

#define DEFINE_MEMBER_INT8_PRIVATE(_NAME)               \
    DEFINE_MEMBER_INT_TYPE_PRIVATE(int8_t, _NAME)

#define DEFINE_MEMBER_UINT8_PUBLIC(_NAME)               \
    DEFINE_MEMBER_INT_TYPE_PUBLIC(uint8_t, _NAME)

#define DEFINE_MEMBER_UINT8_PRIVATE(_NAME)              \
    DEFINE_MEMBER_INT_TYPE_PRIVATE(uint8_t, _NAME)

#define DEFINE_MEMBER_INT16_PUBLIC(_NAME)               \
    DEFINE_MEMBER_INT_TYPE_PUBLIC(int16_t, _NAME)

#define DEFINE_MEMBER_INT16_PRIVATE(_NAME)              \
    DEFINE_MEMBER_INT_TYPE_PRIVATE(int16_t, _NAME)

#define DEFINE_MEMBER_UINT16_PUBLIC(_NAME)              \
    DEFINE_MEMBER_INT_TYPE_PUBLIC(uint16_t, _NAME)

#define DEFINE_MEMBER_UINT16_PRIVATE(_NAME)             \
    DEFINE_MEMBER_INT_TYPE_PRIVATE(uint16_t, _NAME)

#define DEFINE_MEMBER_INT32_PUBLIC(_NAME)               \
    DEFINE_MEMBER_INT_TYPE_PUBLIC(int32_t, _NAME)

#define DEFINE_MEMBER_INT32_PRIVATE(_NAME)              \
    DEFINE_MEMBER_INT_TYPE_PRIVATE(int32_t, _NAME)

#define DEFINE_MEMBER_UINT32_PUBLIC(_NAME)              \
    DEFINE_MEMBER_INT_TYPE_PUBLIC(uint32_t, _NAME)

#define DEFINE_MEMBER_UINT32_PRIVATE(_NAME)             \
    DEFINE_MEMBER_INT_TYPE_PRIVATE(uint32_t, _NAME)

#define DEFINE_MEMBER_INT64_PUBLIC(_NAME)               \
    DEFINE_MEMBER_INT_TYPE_PUBLIC(int64_t, _NAME)

#define DEFINE_MEMBER_INT64_PRIVATE(_NAME)              \
    DEFINE_MEMBER_INT_TYPE_PRIVATE(int64_t, _NAME)

#define DEFINE_MEMBER_UINT64_PUBLIC(_NAME)              \
    DEFINE_MEMBER_INT_TYPE_PUBLIC(uint64_t, _NAME)

#define DEFINE_MEMBER_UINT64_PRIVATE(_NAME)             \
    DEFINE_MEMBER_INT_TYPE_PRIVATE(uint64_t, _NAME)
...
#define DEFINE_MEMBER_VAR_PUBLIC(_TYPE, _NAME)    \
    DEFINE_MEMBER_VAR(_TYPE, _NAME, public)

#define DEFINE_MEMBER_VAR_PRIVATE(_TYPE, _NAME)   \
    DEFINE_MEMBER_VAR(_TYPE, _NAME, private)
...
#define DEFINE_MEMBER_SET_PUBLIC(_TYPE, _NAME)    \
    DEFINE_MEMBER_SET(_TYPE, _NAME, public)

#define DEFINE_MEMBER_SET_PRIVATE(_TYPE, _NAME)   \
    DEFINE_MEMBER_SET(_TYPE, _NAME, private)
